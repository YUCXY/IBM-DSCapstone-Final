...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider', min=0, max=10000, step=1000, value=[min_payload, max_payload], marks={0:0, 2500:2500, 5000:5000, 7500:7500}),
...
def get_scatter(v1, v2):
    filtered_df2=spacex_df[(spacex_df['Payload Mass (kg)'] > v2[0]) & (spacex_df['Payload Mass (kg)'] < v2[1])]
    ...
    if v1 == 'All Sites':
        ...
        filtered_df2_2=filtered_df2[filtered_df2['Launch Site']==v1]
        fig = px.scatter(filtered_df2, x="Payload Mass (kg)", y='class', color="Booster Version Category")
        return fig
